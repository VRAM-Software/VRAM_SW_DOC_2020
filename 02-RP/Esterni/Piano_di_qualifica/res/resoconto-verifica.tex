...
\begin{itemize}
	\item \textbf{M01 Scostamento dei requisiti individuati}: viene registrato uno spostamento significativo dei requisiti individuati, il gruppo ora ha una comprensione migliore delle richieste del proponente quindi questa problematica non dovrebbe ripresentarsi in futuro;
