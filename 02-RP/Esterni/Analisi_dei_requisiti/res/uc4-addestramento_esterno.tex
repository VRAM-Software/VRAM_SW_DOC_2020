...
\begin{figure}[H]
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img/UC4_2_-_Selezione_del_modello_di_predizione_su_cui_eseguire_l'addestramento.png}
	\caption{Diagramma degli use case di UC4.2}
\end{figure}
\begin{itemize}
