...
\begin{figure}[H]
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{img/UC1_2_-_Selezione_del_modello_di_predizione_su_cui_eseguire_l'addestramento.png}
	\caption{Diagramma degli use case di UC1.2}
\end{figure}
\begin{itemize}
