...
\subsection{Requisiti funzionali}
	...
	\rowcolor{gray!50}
		...
		R3F1.4 & Opzionale & L'utente deve poter chiudere l'addestramento dell'algoritmo di predizione & Interno UC1.4 \TBstrut \\ [2mm]
		...
		R1F4.2 & Obbligatorio & L'utente deve poter scegliere il modello di predizione tra su cui applicare l'addestramento & Capitolato UC4.2 \TBstrut \\ [2mm]
		...
		R1F5 & Obbligatorio & L'utente deve visualizzare il grafico della qualità delle previsioni eseguite sull'applicazione esterna & Capitolato UC5 \TBstrut \\ [2mm]
		R1F5.1 & Obbligatorio & L'utente deve visualizzare l'indice di qualità delle previsioni R$^{2}$\glo & Capitolato UC5.1 \TBstrut \\ [2mm]
		R1F5.2 & Obbligatorio & L'utente deve visualizzare gli indici di qualità delle previsioni Precision & Capitolato UC5.2 \TBstrut \\ [2mm]
		R1F5.3 & Obbligatorio & L'utente deve visualizzare gli indici di qualità delle previsioni Recall & Capitolato UC5.3 \TBstrut \\ [2mm]
		...
		R1F19 & Obbligatorio & L'utente deve abilitare il plug-in & Interno UC19 \TBstrut \\ [2mm]
		...
		R1F20 & Obbligatorio & L'utente deve disabilitare il plug-in & Interno UC20 \TBstrut \\ [2mm]	
