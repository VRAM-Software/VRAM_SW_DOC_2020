\section{Processi primari}
	...
	\subsection{Sviluppo}
		...
		\end{itemize}
		\subparagraph*{Metriche di qualità} %VANNO MESSE A INDICE?? VEDI DA RA 8LAB
		Le metriche di qualità utilizzate per valutare la qualità dell'analisi dei requisiti sono:
		\begin{itemize}
			\item la percentuale di requisiti obbligatori soddisfatti (\textbf{PROS}), calcolata con la seguente formula: $\frac{requisiti \; obbligatori \; soddisfatti}{requisiti \; obbligatori \; totali}$; \\
			\item la percentuale di requisiti desiderabili soddisfatti (\textbf{PRDS}), calcolata con la seguente formula: $\frac{requisiti \; desiderabili \; soddisfatti}{requisiti \; desiderabili \; totali}$.
		\end{itemize}		
		\pagebreak
