\section{Processi primari}
	\subsection{Fornitura}
		...
		\subsubsection{Attività}
			...
			\subparagraph*{Scopo}
				...
				Perciò risulta necessario individuare pregi e difetti di ogni capitolato\glosp per determinare quello che si bilancia meglio con le aspettative e le risorse a disposizione del gruppo. 
			...
			\paragraph{Preparazione della risposta}
				Si deve una proposta alle richieste del proponente del capitolato\glosp scelto da gruppo.
			\paragraph{Contrattazione con il proponente}
				Si deve negoziare con il proponente al fine di stipulare un contratto per la fornitura del nostro prodotto\glosp software che sia sostenibile per entrambe le parti. Uno degli elementi fondamentali nella stipulazione del contratto è la qualità del prodotto\glosp che vogliamo realizzare.
				...
				In particolare vengono confrontati gli incrementi del software che realizziamo e, nel corso del progetto, si decidono in comune accordo cosa sviluppare e se soddisfa i requisiti richiesti.
			\paragraph{Pianificazione}
				...
				La pianificazione deve ricevere in input gli obiettivi di qualità stabiliti perché rappresentano uno degli elementi fondanti di tale attività. Inoltre deve essere fissata la descrizione di strategie e tecniche di verifica e validazione\glosp che devono essere applicate dai verificatori nelle loro attività.
				\subparagraph*{Piano di Qualifica}\mbox{}\\ [1mm]
				Un prodotto\glosp necessario per lo svolgimento di questa attività è un documento redatto dai verificatori ed è chiamato \textit{Piano di Qualifica}. Questo documento si pone l'obiettivo di garantire la qualità di prodotto\glosp e la qualità di processo\glosp ed è composto da:
				\begin{itemize}
	...
	\subsection{Sviluppo}
		...
		\begin{itemize}
			...
			\item realizzare un prodotto\glosp che soddisfi i requisiti imposti dal proponente e superi i test per avere una buona qualità.
		\end{itemize}
		\subsubsection{Descrizione}
		...
		Lo scopo di questa attività è così definito:
		\begin{itemize}
			...
			\item definire e classificare i requisiti;
		...
		\end{itemize}
		\textbf*{Technology Baseline}\mbox{}\\ [1mm]
