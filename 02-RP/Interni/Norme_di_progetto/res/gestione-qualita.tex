...
Il parametro che abbiamo utilizzato è il seguente:
	\begin{itemize}
		\item \textbf{M10 Percentuale di metriche soddisfatte (PMS)}: indica la percentuale di metriche\glosp soddisfatte rispetto alla totalità di metriche\glosp utilizzare all'interno del progetto\glo;
		\begin{itemize}
