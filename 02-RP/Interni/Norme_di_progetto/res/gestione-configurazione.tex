\subsection{Gestione della configurazione}
	...
	\subsubsection{Attività}
		...
		\subparagraph*{Numerazione delle versioni del documento} %AGGIUNGERE NUMERAZIONE CODICE SORGENTE
		...
		\paragraph{Utilizzo di Git} %SPIEGARE UTILIZZO DI GIT DA PARTE NOSTRA 3.2.2.6 NDP 8-LAB RA
	...
	\paragraph{Repository}\mbox{}\\ [1mm]
		...
		\end{center}
		\subparagraph{Struttura del repository} %VERIFICARE COM'E ORA LA STRUTTURA ED EVENTUALMENTE AGGIORNARLA
	...
	\paragraph{GitHub} %VEDI TECNOLOGIE 3.2.2.2 NDP 8-LAB DELL'RA
