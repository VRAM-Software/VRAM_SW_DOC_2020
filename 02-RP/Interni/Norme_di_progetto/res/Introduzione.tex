...
Per avere un riferimento univoco alle metriche che permetta una più facile individuazione delle stesse nei documenti viene utilizzato un codice identificativo. Questo codice avrà la seguente struttura: \\
\textbf{M[Numero][Nome]} \\
dove 
\begin{itemize}
	\item \textbf{M} indica che si tratta di una metrica;
	\item \textbf{Numero} è un numero progressivo di due cifre.
	\item \textbf{Nome} breve frase che descrive il contenuto della metrica.
\end{itemize}
