\section{Processi organizzativi}
	\subsection{Gestione organizzativa}
		...
		Il responsabile di progetto\glosp assieme all'amministratore pianificano la gestione e l'utilizzo delle risorse del progetto\glo, necessarie per eseguire le attività.
			\subparagraph{Metriche di qualità}
			Le metriche\glosp utilizzate per valutare la qualità della pianificazione sono:
			\begin{itemize}
