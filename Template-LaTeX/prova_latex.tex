...
\input{package.tex} %include il file package.tex
\input{config_latex.tex} %inclusione file che permette di modificare i vari comandi custom
\input{template_latex.tex} %inclusione file principale con la pagina del titolo
\input{log-table.tex} %inclusione file con tabella diario delle modifiche
\pagebreak
...
\pagebreak
\input{res/sezione-di-prova.tex}
\pagebreak
\input{res/sezione-di-prova.tex}
\pagebreak
