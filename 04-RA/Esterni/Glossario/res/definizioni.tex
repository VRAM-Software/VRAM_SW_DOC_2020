...
Modello di sviluppo software, estensione del modello a cascata. Il modello, invece di discendere le diverse fasi dello sviluppo software lungo una linea retta, dopo la fase di programmazione risale con una tipica forma a V. Il modello dimostra la relazione tra ogni fase del ciclo di vita dello sviluppo del software e la sua fase di testing. 

\subsection*{Modifiche maggiori}
Sono modifiche che impattano in modo rilevante l'interazione che l'utente ha con il prodotto\glo, come ad esempio cambiamenti che modificano i passaggi da effettuare per compiere un'azione. Vengono considerate modifiche maggiori anche quelle che cambiano in modo rilevante il design grafico del prodotto\glosp o che richiedono tempi di sviluppo superiori alla media. Se necessario, le modifiche maggiori possono non essere retro compatibili con le precedenti versioni del prodotto\glo.

\subsection*{Modifiche minori}
Sono modifiche che impattano in modo poco rilevante l'interazione che l'utente ha con il prodotto\glo, come ad esempio cambiamenti che aggiungo funzionalità minori od accessorie alle funzionalità principali del prodotto\glo. Vengono considerate modifiche minori anche quelle che cambiano in modo non rilevante il design grafico del prodotto\glo. Le modifiche minori devono essere sempre retro compatibili con le precedenti versioni del prodotto\glo.
