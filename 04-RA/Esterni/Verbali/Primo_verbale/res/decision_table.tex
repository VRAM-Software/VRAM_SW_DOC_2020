...
\begin{longtable} {
	...
	VE\_5.1 & Prosecuzione sviluppo incrementi come previsto. \TBstrut \\ [2mm]
	VE\_5.2 & Adozione del design pattern architetturale MVVM per l'applicativo esterno. \TBstrut \\ [2mm]
	VE\_5.3 & Adozione del design pattern architetturale MVC supportato da un'architettura a strati per il plug-in. \TBstrut \\ [2mm]
	VE\_5.4 & Implementazione funzione di riaddestramento come richiesto dal proponente. \TBstrut \\ [2mm]
