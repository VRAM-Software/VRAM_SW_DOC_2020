...
\newcommand{\DocDate}{9 maggio 2020} %variabile usata dal file template_latex.tex; Impostata manualmente, altrimenti ad ogni compilazione viene messa la data del giorno di compilazione.
...
\newcommand{\test}{Santagiuliana Vittorio \\ & Rampazzo Marco} %variabile usata dal file template_latex.tex per settare il verificatore del documento
