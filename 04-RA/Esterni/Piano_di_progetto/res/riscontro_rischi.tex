...
\section{Riscontro dei rischi}
    ...
    \rowcolors{2}{gray!25}{gray!15}
        ...
        \rowcolor{gray!50}
        \textbf{ID} & \textbf{Tempistiche} & \textbf{Descrizione} & \textbf{Manutenzione migliorativa} \TBstrut \\
        RT2 & Collaudo del plug-in & Durante lo sviluppo del nostro prodotto\glosp la piattaforma Grafana\glosp è stata aggiornata. Questi aggiornamenti, purtroppo, non hanno mantenuto la retrocompatibilità con il plug-in da noi sviluppato causando quindi il malfunzionamento di quest'ultimo & È stata necessaria un'operazione di revisione sul plug-in per adattare alcuni componenti alla nuova versione di Grafana\glosp ed assicurarne il corretto funzionamento \TBstrut \\ [2mm]