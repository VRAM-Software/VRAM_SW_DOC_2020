...
\section{Riscontro dei rischi}
    ...
    \end{longtable}
    \pagebreak
    \subsection{Attualizzazione dei rischi 2020-05-08}
    \rowcolors{2}{gray!25}{gray!15}
        \begin{longtable} {
            >{}p{10mm} 
            >{}p{24mm}
        ...
        \rowcolor{gray!50}
        \textbf{ID} & \textbf{Tempistiche} & \textbf{Descrizione} & \textbf{Manutenzione migliorativa} \TBstrut \\
        RT2 & Collaudo del plug-in & Durante lo sviluppo del nostro prodotto\glosp la piattaforma Grafana\glosp è stata aggiornata. Questi aggiornamenti, purtroppo, non hanno mantenuto la retrocompatibilità con le versioni precedenti e di conseguenza il plug-in da noi sviluppato ha riscontrato dei malfunzionamenti. & È stata necessaria un'operazione di revisione sul plug-in per adattare alcuni componenti alla nuova versione di Grafana\glosp ed assicurarne il corretto funzionamento \TBstrut \\ [2mm]
	    \end{longtable}