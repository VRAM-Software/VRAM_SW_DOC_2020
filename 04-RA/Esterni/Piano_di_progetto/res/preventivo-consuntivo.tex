\textit{}\section{Preventivo} %Meccanismi di controllo e rendicontazione
...
\begin{longtable} {							
	...
	\textbf{Differenza Totale}& 0           & -12\euro              \TBstrut \\
	\rowcolor{white}
	\caption{Numero di ore effettivamente svolte con rispettivo costo e differenze rispetto al preventivo}	
\end{longtable}
...
\subsubsection{Preventivo a finire generale}
Il bilancio economico risulta positivo di 12\euro. Questo ci permette di presentare un preventivo finale quasi uguale al preventivo concordato in sede di revisione dei requisiti.

\subsubsection{Analisi dei singoli incrementi}
Di seguito viene riportata l'analisi dell'andamento del progetto\glo. Al termine di ogni incremento individuato nella pianificazione, è stato svolto un consuntivo di periodo per poter monitorare la situazione ed eventualmente apportare delle modifiche ai periodi successivi in modo da presentarci ai proponenti con un preventivo finale non peggiore di quanto pianificato.
\paragraph{Incremento 8} \mbox{} \\
Questo incremento prevede lo sviluppo degli indici di qualità dell'addestramento degli algoritmi. \\
La tabella riporta il numero di ore effettivamente svolte dal gruppo e il rispettivo costo con le eventuali differenze rilevate rispetto al preventivo.
\begin{longtable} {							
		>{}p{40mm}  
		>{}p{20mm}	
...
La tabella riporta il numero di ore effettivamente svolte dal gruppo e il rispettivo costo con le eventuali differenze rilevate rispetto al preventivo per l'intero progetto\glo.
\begin{longtable} {							
		>{}p{66mm}  
		>{}p{26mm}
		>{}p{26mm}			
	...
	\textbf{Ruolo}            & \textbf{Ore} & \textbf{Costo}         \TBstrut \\
	Responsabile              & 47 (+1)      & 1410\euro (+30\euro)   \TBstrut \\
	Amministratore            & 40 (+2)      & 800\euro (+40\euro)    \TBstrut \\
	Analista                  & 41 (-6)      & 1025\euro (-150\euro)  \TBstrut \\
	Progettista               & 184 (+1)     & 4048\euro (+22\euro)   \TBstrut \\
	Programmatore             & 232 (+5)     & 3480\euro (+75\euro)   \TBstrut \\
	Verificatore              & 171 (-2)     & 2565\euro (-30\euro)   \TBstrut \\
	\textbf{Totale Preventivo}& 714          & 13341\euro             \TBstrut \\	
	\textbf{Totale Consuntivo}& 715          & 13328\euro             \TBstrut \\	
	\textbf{Differenza Totale}& +1           & -13\euro               \TBstrut \\
	\rowcolor{white}
	\caption{Numero di ore effettivamente svolte con rispettivo costo e differenze rispetto al preventivo}	
\end{longtable}
...
Rappresentate anche dai grafici:
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/tot1.png}
	\caption{Grafico delle ore preventivate rispetto alle ore effettive}
\end{figure}

\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/tot2.png}
	\caption{Grafico dei costi preventivati rispetto ai costi effettivi}
\end{figure}

\subsubsection{Conclusioni}
Il bilancio totale orario del nostro progetto\glosp risulta negativo perché è stata necessaria un'ora di lavoro in più rispetto a quanto preventivato. \\
Come si può notare dai consuntivi di periodo, i nostri bilanci sono sempre migliorati col tempo, questo è dovuto al fatto che l'inesperienza iniziale non ci ha permesso di individuare correttamente le ore necessarie per ciascun ruolo in ogni periodo. Siamo tuttavia riusciti a non discostarci troppo da quanto preventivato grazie alle continue rilevazioni dell'andamento del nostro lavoro e la successiva applicazione di misure atte a mitigare gli scostamenti osservati. In particolare, è risultato essenziale cambiare la pianificazione del periodo di progettazione\glosp di dettaglio e codifica a seguito degli scostamenti troppo importanti nel periodo di progettazione\glosp architetturale. \\
In conclusione possiamo quindi ritenerci abbastanza soddisfatti perché con l'avanzare del tempo e l'incremento della nostra esperienza, siamo riusciti a migliorare la gestione delle risorse, intervenendo adeguatamente con le dovute accortezze.

\subsubsection{Preventivo a finire}
Il bilancio totale economico risulta positivo perché abbiamo speso meno di quanto pianificato. \\
Anche nella gestione delle risorse economiche è risultata fondamentale l'attività di verifica continua che ci ha permesso di intervenire tempestivamente e di conseguenza adeguatamente, per non eccedere i costi presentati in sede di revisione dei requisiti. \\
L'aggiornamento della pianificazione del periodo di progettazione\glosp di dettaglio si è rilevato fondamentale a tale scopo. \\
Il preventivo a finire risulta quindi positivo e, in particolare, c'è stato un risparmio di 13\euro{ } totali sul costo preventivato come indicato nella tabella precedente. \\
La tabella seguente riporta il preventivo a finire aggiornato con le modifiche rilevate nel consuntivo.
\begin{longtable} {
		>{}p{70mm}
		>{}p{15mm}
		>{}p{23mm}
	...
	\textbf{Periodo} & \textbf{Ore} & \textbf{Costo} \TBstrut \\
	Progettazione architetturale          & 205          & 3836,00\euro{} \TBstrut \\
	Progettazione di dettaglio e codifica & 370          & 7159,00\euro{} \TBstrut \\
	Validazione e collaudo                & 140          & 2333,00\euro{} \TBstrut \\
	\textbf{Totale}                       & \textbf{715} & \textbf{13328,00\euro{}} \TBstrut \\		
	\rowcolor{white}
