...
In conclusione possiamo quindi ritenerci abbastanza soddisfatti perché col tempo e l'esperienza siamo riusciti a migliorare la gestione delle risorse, intervenendo adeguatamente con le dovute accortezze.

\subsubsection{Preventivo a finire}
Il bilancio totale economico risulta positivo perché abbiamo speso meno di quanto pianificato. \\
Anche nella gestione delle risorse economiche è risultata fondamentale l'attività di verifica continua per permetterci di intervenire tempestivamente e, quindi, adeguatamente con le dovute accortezza per non eccedere i costi presentati in sede di revisione dei requisiti. \\
...
Il preventivo a finire risulta quindi positivo, in particolare c'è stato un risparmio di 13\euro{ } totali sul costo preventivato come indicato nella tabella precedente. 
