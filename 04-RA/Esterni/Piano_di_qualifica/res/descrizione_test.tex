...
\begin{longtable} {
	...
	TA1 & Verificare che l'utente possa addestrare gli algoritmi di previsione sull'applicazione & I & P & 1 & \TBstrut \\ [2mm]
	...
	TA2 & Verificare che l'utente possa visualizzare un grafico a dispersione che rappresenti i dati utilizzati per l'addestramento nell'applicazione & I & P & 1 & \TBstrut \\ [2mm]
	...
	TA7 & Verificare che, alla fine del processo di addestramento, vengano visualizzati gli indici di qualità delle previsioni eseguite sull'applicazione di addestramento & I & P & 1 & \TBstrut \\ [2mm]
	...
	TA10 & Verificare che l'utente possa caricare il file JSON ottenuto dall'addestramento effettuato dall'applicazione & I & P & 1 & \TBstrut \\ [2mm]
