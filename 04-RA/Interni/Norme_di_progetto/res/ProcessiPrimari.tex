\section{Processi primari}
	\subsection{PRC-Q1 Fornitura}
		...
		Per questo processo non sono stati definiti obiettivi di qualità rilevanti.
	...
	\subsubsection{Obiettivi di qualità}
		...
		Le metriche\glosp utilizzate sono:
		\begin{itemize}
			%\item \textbf{M-PROC Accoppiamento tra le classi di oggetti}: indica se una classe è accoppiata ad una seconda. Con accoppiamento s'intende l'utilizzo, da parte della prima classe, di metodi o variabili definiti nella seconda; 
			%\begin{itemize}
			%	\item[] \textbf{Formula}: si calcola con un valore intero.
			%\end{itemize}
