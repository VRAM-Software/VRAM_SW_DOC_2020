\section{Processi di supporto}
    \subsection{Documentazione}
        \subsubsection{Descrizione}
            In questo capitolo verrà illustrato come il gruppo ha gestito il processo di redazione della documentazione utile ai fini del progetto.
        ...
        \subsubsection{Struttura dei documenti}
            \paragraph{Template \LaTeX} \mbox{}\\ \mbox{}\\
                Per la produzione di documenti consistenti e coerenti tra loro il gruppo ha deciso di creare un template \LaTeX\glosp che permette, al momento della
                ...
                \begin{itemize}
                    ...
                    \item un file contenente i pacchetti \LaTeX\glosp utilizzati per una migliore rappresentazione dei contenuti;
            ...
            \paragraph{Prima pagina} \mbox{}\\ \mbox{}\\
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Capitolato\glo}: nome del progetto scelto dal gruppo (\textit{Predire in Grafana}), centrato orizzontalmente;
                    ...
                    \begin{itemize}
                        ...
                        \item nominativo/i del/i verficatore/i del documento;
            ...
            \paragraph{Registro delle modifiche} \mbox{}\\ \mbox{}\\
                La pagina successiva mostra una tabella contente una raccolta cronologica delle modifiche avvenute sul documento.
        ...
        \subsubsection{Norme tipografiche}
                \paragraph{Nomi dei file} \mbox{}\\ \mbox{}\\
                    Per organizzare i file in modo più ordinato e corretto il gruppo ha scelto di seguire la pratica dello "snake\_case"\glo.
                    Tale prassi, nell'ambito di questo progetto, è applicata seguendo tre regole:
                    \begin{itemize}
                        \item i file con nome più lungo di una parola useranno il carattere underscore come separatore;
                ...
                \paragraph{Convenzioni} \mbox{}\\ \mbox{}\\
                    Vengono usate tre convenzioni per le date, la valuta e gli orari (i quali prendono come riferimento ISO 8601). Le date saranno espresse nella forma: \newline \newline
                    \centerline{\textbf{DD-MM-YYYY}} \newline \newline
                    dove:
                    \begin{itemize}
            ...
            \subsubsection{Produzione}
                    Il progetto prevede la stesura di documenti che si dividono in interni ed esterni a seconda dei destinatari. Questi elaborati verranno poi valutati
                ...
                \paragraph{Documenti esterni}
                    \begin{itemize}
                        \item \textbf{Analisi dei Requisiti - AdR}: contiene la descrizione degli attori del sistema e la loro interazione con i casi d'uso,
                        ...
                        \item \textbf{Piano di Qualifica - PdQ}: fornisce le specifiche riguardanti il controllo qualità dei processi e dei
                                                                 prodotti tramite delle metriche misurabili.
                    \end{itemize}
                \paragraph{Documenti interni}
                    \begin{itemize}
                        \item \textbf{Glossario - G}: documento dove sono riportate i termini più specifici e tecnici che necessitano di
                                                      approfondimento;
                        \item \textbf{Norme di Progetto - NdP}: linee guida per la gestione delle attività di progetto;
                        \item \textbf{Studio di Fattibilità - SdF}: breve analisi di tutti i capitolati proposti.
                    \end{itemize}
                \paragraph{Verbale} \mbox{}\\ \mbox{}\\
                    Il verbale della riunione è un documento più particolare in quanto può essere sia interno che esterno. Sarà interno quando
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Revisione di Progettazione - RP}: revisione intermedia per accertare la fattibilità del progetto;
                    \item \textbf{Revisione di Qualifica - RQ}: revisione intermedia per l'approvazione delle verifiche e l'attivazione del processo di validazione;
                    \item \textbf{Revisione di Accettazione - RA}: revisione finale per il collaudo del software e l'accertamento del soddisfacimento dei requisiti
                                                                   presentati in RR.
                \end{itemize}
            ...
            \subsubsection{Elementi grafici}
                    ...
                    \paragraph{Didascalie} \mbox{}\\ \mbox{}\\
            ...
            \subsubsection{Strumenti}
                    \paragraph{\LaTeX} \mbox{}\\ \mbox{}\\
                        Per stilare i documenti è stato usato il linguaggio di markup \LaTeX\glo. Questo linguaggio permette di scrivere dei testi mantenendo il focus
                        sul contenuto e non sulla forma. La struttura infatti è stata dichiarata all'inizio del progetto e poi riutilizzata permettendo una gestione
                        degli elaborati scalabile, modulare e ordinata.
                    \paragraph{TeXStudio} \mbox{}\\ \mbox{}\\
                        Per scrivere in \LaTeX\glosp è stata usata l'IDE \textit{TeXStudio}\glosp creata appositamente per questo fine, offre perciò delle scorciatoie
                    ...
                    \paragraph{Lucidchart} \mbox{}\\ \mbox{}\\
                        Per la creazione dei diagrammi UML\glosp e di Gantt\glosp viene usata la piattaforma online Lucidchart\glo. \newline \newline
