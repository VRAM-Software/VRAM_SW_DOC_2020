...
\begin{itemize}
	...
	\item \textbf{Complessità delle espressioni di decisione}: numero di condizioni da verificare in un test, da limitare perché indica il grado di complessità del branch coverage\glo.
\end{itemize}
\subsubsection{Strumenti}
