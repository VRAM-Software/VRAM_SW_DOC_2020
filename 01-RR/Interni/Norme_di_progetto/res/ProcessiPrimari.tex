...
\begin{itemize}
	\item \textbf{Qualità di Processo}: individuazione dei processi da adottare in riferimento ad uno standard e delle metriche\glosp per la misurazione e il monitoraggio della qualità;
	\item \textbf{Qualità di Prodotto}: individuazione delle caratteristiche del prodotto necessarie per raggiungere e una buona qualità e delle metriche\glosp per misurarla;
	...
	\item \textbf{Resoconto delle attività di verifica}: resoconti dei risultati dati dalle metriche\glosp di qualità calcolate per ogni attività.
\end{itemize}
...
\textbf{SV: Schedule Variance} che segnala se si è in anticipo o in ritardo nello svolgimento di quanto pianificato e si misura con la formula: EV - PV;
\textbf{CV: Cost Variance} che segnala la differenza tra il costo del lavoro svolto rispetto a quello pianificato e si misura con la formula: EV - PV.
...
%Aggiungere eventuali screen di Excel e/o Project
...
\begin{itemize}
	...
	\item Fornire una base solida da cui poter effettuare raffinamenti successivi e un miglioramento continuo del progetto\glo.
