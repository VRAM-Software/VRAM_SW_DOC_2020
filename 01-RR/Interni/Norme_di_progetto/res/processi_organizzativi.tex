	...
	\subsection{Gestione organizzativa}
		...
		\subsubsection{Gestione degli strumenti di coordinamento}
			\paragraph*{Ticketing}
				...
				Il responsabile di progetto\glosp ha l'incarico di assegnare i compiti ai membri del gruppo attraverso le Issue\glosp. Ognuna di esse contiene titolo, descrizione, milestone, le project board Kanban automatizzate associate e il destinatario.
