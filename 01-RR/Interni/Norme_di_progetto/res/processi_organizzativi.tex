...
\section{Processi organizzativi}
	\subsection{Gestione organizzativa}
		...
		\paragraph{Metriche di qualità}
			\subparagraph{Pianificazione delle risorse}\mbox{}\\ [1mm]
	...
	\subsection{Formazione del gruppo}
		...
		\subsubsection{Aspettative}
			L'aspettativa del gruppo, nel caso di questo processo\glo, è di riuscire a ottimizzare i tempi non impiegando tutti i membri nell'apprendimento di uno stesso strumento o tecnologia, ma lavorare in modo parallelo, al fine di assimilare più concetti possibili per poi condividerli con gli altri componenti.
		\subsubsection{Descrizione}
