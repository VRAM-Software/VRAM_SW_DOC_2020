...
\begin{itemize}
	...
	\item \textbf{Titolo}: Definizione di un alert;
...
\begin{itemize}
	...
	\item \textbf{Titolo}: Inserimento di un alert;
	\item \textbf{Attore primario}: utente;
	\item \textbf{Attore secondario}: Grafana\glo;
...
\begin{itemize}
	...
	\item \textbf{Titolo}: Definizione della regola dell'alert;
	\item \textbf{Attore primario}: utente;
	\item \textbf{Attore secondario}: Grafana\glo;
...
\begin{itemize}
	...
	\item \textbf{Titolo}: Definizione delle condizioni dell'alert;
	\item \textbf{Attore primario}: utente;
	\item \textbf{Attore secondario}: Grafana\glo;
...
\subsubsection{UC12.4 - Definizione dei casi speciali dell'alert}
	...
	\item \textbf{Titolo}: Definizione dei casi speciali dell'alert;
	\item \textbf{Attore primario}: utente;
	\item \textbf{Attore secondario}: Grafana\glo;
