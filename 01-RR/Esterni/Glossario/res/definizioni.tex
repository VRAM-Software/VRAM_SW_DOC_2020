...
\subsection*{Git}
Git è un software di controllo versione distribuito creato da Linus Torvalds nel 2005. Le sue caratteristiche di richiedere poche risorse, non avere fronzoli ed essere open-source\glosp lo rendono molto usato.
...
Tecnica di previsione tramite cui, a partire da un dato, ne produco un altro continuo, cioè un dato non discreto che ha valori quindi valori in $\mathbb{R}$
