...
\begin{longtable} {
	...
	VE\_2.1 & Revisione use case di creazione pannello. \TBstrut \\ [2mm]
	VE\_2.2 & Inserimento use case di collegamento JSON con relativi nodi. \TBstrut \\ [2mm]
	VE\_2.3 & Revisione use case riguardanti la configurazione del plugin. \TBstrut \\ [2mm]
	VE\_2.4 & Modifica requisiti prestazionali come indicato dal proponente. \TBstrut \\ [2mm]
\end{longtable}