...
\begin{itemize}
	%\item \textbf{M-PROC28 Code coverage}: indica la percentuale di codice coperto da test rispetto al totale delle righe di codice;
	%\begin{itemize}
	%	\item[] \textbf{formula}: $\frac{righe \; di \; codice \; coperto}{righe \; di \; codice \; totali}$;
	%\end{itemize} 

	%\item \textbf{M-PROC29 Branch coverage}: indica la percentuale di codice coperto da test rispetto al totale delle righe di codice;
	%\begin{itemize}
	%	\item[] \textbf{formula}: $\frac{righe \; di \; codice \; coperto}{righe \; di \; codice \; totali}$;
	%\end{itemize} 
	...
	%\item \textbf{M-PROC31 Copertura dei test eseguiti}: indica la percentuale di test effettivamente eseguiti;
	%\begin{itemize}
