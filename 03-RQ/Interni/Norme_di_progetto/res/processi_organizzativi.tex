\section{Processi organizzativi}
	\subsection{Gestione organizzativa}
		...
		\paragraph{PR-Q5 Gestione organizzativa}
		\subparagraph{OPRC-7 Pianificazione delle risorse}
		\paragraph*{Obiettivo}
		L'obiettivo è pianificare le risorse per garantire un corretto avanzamento del progetto monitorando costi e tempi.
		\paragraph*{Metriche}
		...
		\subparagraph{OPRC-Q8 Prevenzione dei rischi}
		\paragraph*{Obiettivo}
