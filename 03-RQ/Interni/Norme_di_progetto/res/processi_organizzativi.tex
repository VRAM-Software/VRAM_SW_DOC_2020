\section{Processi organizzativi}
	\subsection{Gestione organizzativa}
		...
		Per gestire le risorse disponibili per il nostro progetto\glosp dobbiamo monitorare il rispetto dei costi e dei tempi preventivati. A tal proposito definiamo
		\paragraph{Ruoli di progetto}
			...
			\paragraph{Esecuzione e controllo}
				Il compito di eseguire e monitorare la gestione organizzativa viene assegnato all'amministratore. Egli infatti deve analizzare e risolvere i problemi che sorgono fornendo inoltre dei report sullo stato di avanzamento di progetto sia internamente che al committente.
			%\paragraph{Pianificazione delle risorse}\mbox{}\\ [1mm]
			%	Per gestire le risorse disponibili per il nostro progetto\glosp dobbiamo monitorare il rispetto dei costi e dei tempi preventivati. 
			\subparagraph{Metriche di qualità}\mbox{}\\ [1mm]
			Le metriche\glosp utilizzate per valutare la qualità della pianificazione delle risorse a nostra disposizione sono:
			\begin{itemize}		
		...
		\paragraph{Gestione delle comunicazioni}
			...
			\subparagraph{Comunicazioni esterne}\mbox{}\\ [1mm]
				Le comunicazioni esterne avvengono tramite la posta elettronica all'indirizzo \url{vram.software@gmail.com} e, oltre ai componenti del gruppo, sono dirette al committente e al proponente.
		...
		\paragraph{Gestione degli incontri}
			\subparagraph{Incontri interni}\mbox{}\\ [1mm]
				...
				\begin{itemize}
					...
					\item \textbf{incontri virtuali}: chiamate o video chiamate di gruppo svolte attraverso l'applicazione Skype. Questa tipologia viene scelta quando si necessita di un incontro, ma la maggior parte dei membri del gruppo si trova scomoda o impossibilitata a raggiungere le sedi dell'Università. 
				\end{itemize}
			...
			\subparagraph{Verbali di incontri esterni}\mbox{}\\ [1mm]
				...
				\end{itemize}
			\subparagraph{Incontri eccezionali}\mbox{}\\ [1mm]
			Il Rettore dell'Università degli Studi di Padova ha emesso delle disposizioni in merito alla pandemia in corso causata dal virus Covid-19 nelle quali è ufficializzata la chiusura delle sedi universitarie a partire dal mese di marzo fino a data da destinarsi. Perciò tutti gli incontri sono obbligatoriamente virtuali.
