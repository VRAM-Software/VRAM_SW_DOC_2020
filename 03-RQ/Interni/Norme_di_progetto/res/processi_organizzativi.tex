\section{Processi organizzativi}
	\subsection{PRC-Q9 Gestione organizzativa}
		\subsubsection{Scopo}
			...
			\end{itemize}
			Queste attività sono definite a cura del responsabile di progetto\glosp e redatte all'interno del documento \textit{Piano di Progetto v. 22.0.0}.
		...
		La gestione e l'analisi dei rischi è un'attività a carico del responsabile di progetto\glosp che deve essere documentata nel documento \textit{Piano di Progetto v. 22.0.0}.
	...
	\subsubsection{Strumenti di supporto}
		...
		\begin{itemize}
			...
			\item \textbf{Skype}: strumento utilizzato per effettuare chiamate o videochiamate per alcuni incontri interni o esterni;
			\item \textbf{Hangouts}: strumento utilizzare per effettuare chiamate e videochiamate per alcuni incontri esterni;
	...
	\subsection{PRC-Q10 Formazione}
		...
		\paragraph{Condivisione del materiale}\mbox{}\\ [1mm]
			...
			Inoltre sono presenti i "Riferimenti Normativi" dentro i quali è presente il documento \textit{Norme di Progetto v. 22.0.0} che tutti devono rispettare.
		\subsubsection{Strumenti di supporto}
		\begin{itemize}
		 	\item \textbf{Skype}: strumento utilizzato per effettuare chiamate o videochiamate per gli incontri di formazione in via telematica;
	 	\end{itemize}
