...
\end{figure}
\mbox{}
In seguito viene presentato il prospetto orario per ogni incremento sviluppato nel macro periodo della progettazione\glosp di dettaglio e codifica. Presenta meno ore totali rispetto al prospetto orario precedentemente indicato perché abbiamo rivisto la pianificazione in seguito al consuntivo del periodo precedente. Questa differenza viene discussa nel consuntivo di periodo della progettazione\glosp di dettaglio e codifica.
\paragraph{Incremento III} \mbox{} \\
Per l'incremento III è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
	...
	\rowcolor{white}
	\caption{Prospetto orario dell'incremento III}
\end{longtable}
Rappresentata nel seguente grafico:
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/17.png}
	\caption{Grafico del prospetto orario dell'incremento III}
\end{figure}
\paragraph{Incremento IV} \mbox{} \\
Per l'incremento IV è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
	...
	\rowcolor{white}
	\caption{Prospetto orario dell'incremento IV}
\end{longtable}
Rappresentata nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/18.png}
	\caption{Grafico del prospetto orario dell'incremento IV}
\end{figure}
\paragraph{Incremento VI} \mbox{} \\
Per l'incremento VI è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
...
\begin{figure} [H]
	...
	\caption{Grafico del prospetto orario dell'incremento VI}
\end{figure}
\paragraph{Incremento XIII} \mbox{} \\
Per l'incremento XIII è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
	...
	\rowcolor{white}
	\caption{Prospetto orario dell'incremento XIII}
\end{longtable}
Rappresentata nel seguente grafico:
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/20.png}
	\caption{Grafico del prospetto orario dell'incremento XIII}
\end{figure}
\paragraph{Incremento XIV} \mbox{} \\
Per l'incremento XIV è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
	...
	\rowcolor{white}
	\caption{Prospetto orario dell'incremento XIV}
\end{longtable}
Rappresentata nel seguente grafico:
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/21.png}
	\caption{Grafico del prospetto orario dell'incremento XIV}
\end{figure}
\paragraph{Incremento XVI} \mbox{} \\
Per l'incremento XVI è prevista la seguente divisione oraria:
\begin{longtable} {				
		>{}p{40mm}  
		>{}p{8mm}
		>{}p{8mm}
	...
	\rowcolor{white}
	\caption{Prospetto orario dell'incremento XVI}
\end{longtable}
Rappresentata nel seguente grafico:
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/22.png}
	\caption{Grafico del prospetto orario dell'incremento XVI}
\end{figure}
\subsubsection{Prospetto economico}
...
\paragraph{Incremento III} \mbox{} \\
Per l'incremento III sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento III}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/23.png}
	\caption{Grafico del prospetto economico dell'incremento III}
\end{figure}
\paragraph{Incremento IV} \mbox{} \\
Per l'incremento IV sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento IV}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/24.png}
	\caption{Grafico del prospetto economico dell'incremento IV}
\end{figure}
\paragraph{Incremento VI} \mbox{} \\
Per l'incremento VI sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento VI}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/25.png}
	\caption{Grafico del prospetto economico dell'incremento VI}
\end{figure}
\paragraph{Incremento XIII} \mbox{} \\
Per l'incremento XIII sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento XIII}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: 
\begin{figure} [h!]
	\includegraphics[width=\linewidth]{./img/Grafici/26.png}
	\caption{Grafico del prospetto economico dell'incremento XIII}
\end{figure}
\paragraph{Incremento XIV} \mbox{} \\
Per l'incremento XIV sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento XIV}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/27.png}
	\caption{Grafico del prospetto economico dell'incremento XIV}
\end{figure}
\paragraph{Incremento XVI} \mbox{} \\
Per l'incremento XVI sono previsti i seguenti costi:
\begin{longtable} {
		>{}p{32mm}
		>{}p{20mm}
		>{}p{20mm}
	...
	\rowcolor{white}
	\caption{Prospetto economico dell'incremento XVI}
\end{longtable} \mbox{} \\
Rappresentati nel seguente grafico: \mbox{}
\begin{figure} [H]
	\includegraphics[width=\linewidth]{./img/Grafici/28.png}
	\caption{Grafico del prospetto economico dell'incremento XVI}
\end{figure}
