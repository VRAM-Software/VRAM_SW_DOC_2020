...
%AGGIUNGERE LO STANDARD DI RIFERIMENTO
	...
	\subsection{PRC-Q6 Processo di verifica}
		...
		\begin{longtable} {
			...
			\rowcolor{gray!50}
			\textbf{Metrica} & \textbf{Preferibile} & \textbf{Accettabile} \TBstrut \TBstrut \\
			M24 Code coverage & $100\%$ & $\ge 80\%$ \TBstrut \\ [2mm]
			M25 Branch coverage & $100\%$ & $\ge 80\%$ \TBstrut \\ [2mm]
			M26 Copertura dei test eseguiti & $\ge 90\%$ & $100\%$ \TBstrut \\ [2mm]
		\end{longtable}	
